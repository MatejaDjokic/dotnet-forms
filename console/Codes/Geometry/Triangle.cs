...
namespace Codes.Geometry
{
    class Triangle
    {
        ...
        {
            // TEMENA
            _points = new Vec2[3] { new Vec2(), new Vec2(), new Vec2() };
        ...
        /// <summary>
        /// Proverava da li trougao sadrzi tacku proveravajuci da li je zbir povrsina trouglaova kreiranih tom tackom jednak povrsini trougla
        /// </summary>
        /// <param name="P"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Racuna centralnu tacku trougla
        /// </summary>
        /// <returns></returns>
